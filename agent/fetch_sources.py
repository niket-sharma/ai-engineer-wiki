...
Usage:
    # Install deps first (from agent/):
    pip install -r requirements.txt

    # Fetch all sources:
    python agent/fetch_sources.py

    # Fetch a single source by key:
    python agent/fetch_sources.py --only attention-is-all-you-need

    # Fetch and immediately trigger ingest (requires claude CLI in PATH):
    python agent/fetch_sources.py --ingest
"""
